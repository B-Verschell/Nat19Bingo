...
function home(){
    return(
        <div>
            ...
            <Button varriant="link" className="btn btn-primary btn-lg btn-block"><Link to ={`/nat19bingo/bingo?game=vestige`}>Vestige of Ophiuchus</Link></Button>
            <Button varriant="link" className="btn btn-primary btn-lg btn-block"><Link to ={`/nat19bingo/bingo?game=dms`}>Devils Might Surrender</Link></Button>
